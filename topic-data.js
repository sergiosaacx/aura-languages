/* ═══════════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════════
   TOMACORRIENTE — no modificar este archivo.
   Los juegos de cada tarjeta viven en topic-data-XX.js
   y se registran con: _registerGames(id, [...juegos])
   ═══════════════════════════════════════════════════════════════ */

/* ── Registro central de juegos ──────────────────────────────── */
var _GAMES_REGISTRY = {};

function _registerGames(topicId, gamesArray) {
  _GAMES_REGISTRY[topicId] = gamesArray;
}
