/* admin-tab-vocab.js -- datos del Hero Card de Vocabulary en el editor admin
   Para cambiar la tarjeta de Vocabulary: solo edita este archivo.
   Tocar este archivo NO afecta ninguna otra pestana. */

window.skillData = window.skillData || {};
window.skillData.vocab = {
    word:'Ubiquitous',
    typo:'Ubiquitous',
    ipa:'/juːˈbɪk.wɪ.təs/',
