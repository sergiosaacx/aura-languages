/* admin-tab-listen.js -- datos del Hero Card de Listening en el editor admin
   Para cambiar la tarjeta de Listening: solo edita este archivo.
   Tocar este archivo NO afecta ninguna otra pestana. */

window.skillData = window.skillData || {};
window.skillData.listen = {
    word:'Mad Men · pitch',
    typo:'Listening',
